  ...
  return (
    <div
      ...
      <div className="hero-text-wrapper">
        <h1
          className="science-gothic-title md:text-7xl text-3xl lg:text-9xl font-bold text-center relative z-20 hero-text-ecell">
          E-Cell
        </h1>
        <h2 className="science-gothic-title md:text-7xl text-3xl lg:text-9xl font-bold text-center relative z-20 hero-text-srmist">SRMIST</h2>
      </div>
      <div className="w-[40rem] h-40 relative">
        ...
        <div
          className="absolute inset-x-60 top-0 bg-gradient-to-r from-transparent via-emerald-400 to-transparent h-[5px] w-1/4 blur-sm" />
        <div
          className="absolute inset-x-60 top-0 bg-gradient-to-r from-transparent via-emerald-400 to-transparent h-px w-1/4" />
